 ...
 * @Author: June
 * @Description: 
 * @Date: 2024-06-15 15:35:14
 * @LastEditTime: 2024-06-15 15:56:09
 * @LastEditors: June
 * @FilePath: \mine-pro\packages\server\src\modules\system\dept\dept.controller.ts
 */
...
export class DeptController {
  ...
  async list(@Query() dto: DeptQueryDto, @AuthUser('uid') uid: number): Promise<DeptEntity[]> {
      console.log('sfsdkfjsdkfjkdsfjsfjd ')
